...
#include "WordEmbedding.pb.h"  // IWYU pragma: export
...
class ModelDescription : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:CoreML.Specification.ModelDescription) */ {
 public:
  ...
  static const int kTrainingInputFieldNumber = 50;
...
class Model : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:CoreML.Specification.Model) */ {
 public:
  ...
  static const int kKNearestNeighborsClassifierFieldNumber = 404;
  ...
  ::CoreML::Specification::KNearestNeighborsClassifier* release_knearestneighborsclassifier();
  ...
  static const int kItemSimilarityRecommenderFieldNumber = 501;
  ...
  static const int kLinkedModelFieldNumber = 556;
  ...
  static const int kSoundAnalysisPreprocessingFieldNumber = 2003;
  ...
  ::CoreML::Specification::CoreMLModels::SoundAnalysisPreprocessing* release_soundanalysispreprocessing();
  ...
  static const int kGazetteerFieldNumber = 2004;
  ...
  ::CoreML::Specification::CoreMLModels::Gazetteer* release_gazetteer();
  ...
  static const int kWordEmbeddingFieldNumber = 2005;
...
inline void Model::clear_knearestneighborsclassifier() {
...
inline void Model::set_allocated_knearestneighborsclassifier(::CoreML::Specification::KNearestNeighborsClassifier* knearestneighborsclassifier) {
  clear_Type();
...
inline void Model::clear_itemsimilarityrecommender() {
...
inline void Model::set_allocated_itemsimilarityrecommender(::CoreML::Specification::ItemSimilarityRecommender* itemsimilarityrecommender) {
  clear_Type();
...
inline void Model::clear_linkedmodel() {
  if (has_linkedmodel()) {
...
inline void Model::set_allocated_linkedmodel(::CoreML::Specification::LinkedModel* linkedmodel) {
  clear_Type();
  if (linkedmodel) {
    set_has_linkedmodel();
...
inline void Model::clear_soundanalysispreprocessing() {
...
inline void Model::set_allocated_soundanalysispreprocessing(::CoreML::Specification::CoreMLModels::SoundAnalysisPreprocessing* soundanalysispreprocessing) {
  clear_Type();
...
inline void Model::clear_gazetteer() {
  if (has_gazetteer()) {
...
inline void Model::set_allocated_gazetteer(::CoreML::Specification::CoreMLModels::Gazetteer* gazetteer) {
  clear_Type();
  if (gazetteer) {
    set_has_gazetteer();
...
inline void Model::clear_wordembedding() {
...
inline void Model::set_allocated_wordembedding(::CoreML::Specification::CoreMLModels::WordEmbedding* wordembedding) {
  clear_Type();
  if (wordembedding) {
    set_has_wordembedding();
